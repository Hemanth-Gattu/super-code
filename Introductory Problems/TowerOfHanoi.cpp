...
#define nl '\n'
 ...
 void TowerOfHanoi (ll n , ll from_stack , ll to_stack , ll aux_stack , vector<pll> &ans){
     // base case : no disk to move 
     if(n<=0){
         return ;
     }

     TowerOfHanoi(n-1 , from_stack , aux_stack , to_stack,ans); // move top n-1 disks stack 1 to stack 2
     ans.pb(make_pair(from_stack,to_stack));   // move disk n from stack 1 to stack 3 
     TowerOfHanoi(n-1 , aux_stack , to_stack , from_stack,ans);   // move n-1 disks from stack 2 to stack 3
